...
<section
    ...
    style="--baseWindowWidth: {width.base}; --baseWindowHeight: {height.base}; --smallWindowWidth: {width.small}; --smallWindowHeight: {height.small};
     --baseShuffleDistance: {distanceFromIntersection.base}; --smallShuffleDistance: {distanceFromIntersection.small}; --largeShuffleDistance: {distanceFromIntersection.large}; position: relative; z-index: {zIndex};"
...
>
    ...
    <div class:no-events={!isInForeground} style="background: {background};">
