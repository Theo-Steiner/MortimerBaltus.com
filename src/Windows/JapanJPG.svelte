...
>
    <div
        style="background-image: url(data:image/svg+xml;base64,{jpGallery[
            randomIndex
        ].svg})"
    >
        <ImageLoader
