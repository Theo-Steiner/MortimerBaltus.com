const c = [
	...
	() => import("../../../src/routes/pages/placeholder.svelte"),
...
export const routes = [
	...
	// src/routes/pages/placeholder.svelte
	[/^\/pages\/placeholder\/?$/, [c[0], c[3], c[4]], [c[1]]],

	// src/routes/pages/privacy.svelte
	[/^\/pages\/privacy\/?$/, [c[0], c[3], c[5]], [c[1]]],

	// src/routes/pages/about.svelte
	[/^\/pages\/about\/?$/, [c[0], c[3], c[6]], [c[1]]],

	// src/routes/pages/legal.svelte
	[/^\/pages\/legal\/?$/, [c[0], c[3], c[7]], [c[1]]]
];
