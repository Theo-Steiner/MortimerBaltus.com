...
class FunctionNode extends NodeBase {
    ...
    hasEffectsWhenCalledAtPath(path, callOptions, context) {
        ...
        context.replacedVariableInits.set(this.scope.thisVariable, callOptions.withNew ? new ObjectEntity({}, OBJECT_PROTOTYPE) : UNKNOWN_EXPRESSION);
